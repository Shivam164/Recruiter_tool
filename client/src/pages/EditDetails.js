...
import { updateCandidate, getSingleCandidate } from '../shared/api';
  ...
  const fetchSingleCandidateData = async () => {
    try{
      ...
      setFormData({
        ...
        reactJS: `${candidate[0].ReactJS}`,
        nodeJS: `${candidate[0].NodeJS}`,
        current_status: `${candidate[0].Current_Status}`,
